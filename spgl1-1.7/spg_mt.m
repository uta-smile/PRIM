function [x,r,g,info] = spg_mt( A, b, groups, sigma, options )
%SPG_GROUP  Solve multi-task sparse 
%
...
sz=options.sz; T=size(sz,1); pn=sz(1,3);
...
tau = 0;
x0  = [];
[x,r,g,info] = spgl1_mt(A,b,tau,sigma,x0,options);
